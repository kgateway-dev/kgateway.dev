...
<section class="bg-primary-bg text-white pt-[7.875rem] pb-40 bg-[url(/hero-background.svg)] bg-center bg-no-repeat bg-[length:61.85319rem_60.14119rem] lg:bg-auto">
  ...
  <div class="flex gap-8 flex-wrap justify-center px-8 md:px-12 xl:px-25">
    <div class="flex gap-8 flex-wrap w-full md:w-auto">
      <a href="/docs/envoy/latest/migrate/" class="flex md:flex-col items-start bg-card-bg px-4 py-[3.75rem] gap-[1.6875rem] md:gap-[3.125rem] w-full md:w-[17.875rem] min-h-[7.4375rem] md:min-h-[25rem] flex-wrap justify-start rounded-xl">
      ...
      <a href="/docs/envoy/latest/about/overview" class="flex md:flex-col items-start bg-card-bg px-4 py-[3.75rem] gap-[1.6875rem] md:gap-[3.125rem] w-full md:w-[17.875rem] min-h-[7.4375rem] md:min-h-[25rem] flex-wrap justify-start rounded-xl">
        <div class="flex flex-row md:flex-col gap-8 justify-center items-center">
        ...
        <p class="text-primary-text text-center px-4 md:min-h-24">Centralize authentication, authorization, rate limiting, and aggregation for your APIs in one place.</p>
      </a>
    </div>
    <div class="flex gap-8 flex-wrap w-full md:w-auto">
      <a href="/docs/envoy/latest/setup/" class="flex md:flex-col items-start bg-card-bg px-4 py-[3.75rem] gap-[1.6875rem] md:gap-[3.125rem] w-full md:w-[17.875rem] min-h-[7.4375rem] md:min-h-[25rem] flex-wrap justify-start rounded-xl">
        <div class="flex flex-row md:flex-col gap-8 justify-center items-center">
        ...
        <p class="text-primary-text text-center px-4 md:min-h-24">Built on Envoy Proxy and the Kubernetes Gateway API, kgateway is trusted at scale by some of the largest deployments in the world.</p>
      </a>
      <a href="https://agentgateway.dev/docs" class="flex md:flex-col items-start bg-card-bg px-4 py-[3.75rem] gap-[1.6875rem] md:gap-[3.125rem] w-full md:w-[17.875rem] min-h-[7.4375rem] md:min-h-[25rem] flex-wrap justify-start rounded-xl">
        <div class="flex flex-row md:flex-col gap-8 justify-center items-center">
          <img src="/use-case-ai.svg" class="w-16 h-16 md:w-20 md:h-20 object-contain" />
          <h3 class="font-semibold text-[1.25rem] md:text-[1.5625rem] leading-[1.71875rem] text-primary-text font-heading text-center min-h-16">An AI-First Gateway for LLMs, Agents, and MCP</h3>
        </div>
        <p class="text-primary-text text-center px-4 md:min-h-24">Secure and govern AI workloads with agentgateway, a related project specifically designed for inference, agentic, and MCP traffic.</p>
      </a>
    </div>
  </div>  
</section>
...
<section id="use-cases" class="py-[4.375rem] md:py-50 px-4 md:px-12 xl:px-25 flex flex-col gap-[3.125rem] md:gap-[6.94rem] items-center max-w-[1440px] mx-auto">
  ...
  <div class="flex gap-8 flex-wrap justify-center">
    <div class="flex gap-8 flex-wrap w-full md:w-auto">
      <div class="flex md:flex-col items-center bg-card-bg px-4 py-[3.75rem] gap-[1.6875rem] md:gap-[3.125rem] w-full md:w-[17.875rem] min-h-[7.4375rem] md:min-h-[25rem] flex-wrap justify-start rounded-xl">
        <div class="flex flex-row md:flex-col gap-8 justify-center items-center">
