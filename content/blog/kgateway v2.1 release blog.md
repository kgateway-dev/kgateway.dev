...
You are now ready to try out agentgateway. Check out the [agentgateway guides]({{< link-hextra path="/ai" >}}) to learn how to route traffic to an LLM provider, MCP tool server, or AI agent. 
...
AI Gateway and Inference Extension support for Envoy-based gateway proxies is deprecated and is planned to be removed in version 2.2. If you want to use AI capabilities, use an [agentgateway proxy](/ai) instead. To learn more about why we think that agentgateway is better suited as a gateway for agentic AI and MCP workloads, check out this [blog](https://www.solo.io/blog/why-do-we-need-a-new-gateway-for-ai-agents). 
