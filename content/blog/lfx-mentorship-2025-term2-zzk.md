...
Instead of rushing to submit my application, I first went to actually experience the product involved in the project: [AI Gateway](https://kgateway.dev/docs/envoy/2.1.x/ai/about/). During usage, I discovered a practical problem - I couldn't directly access the LLM service providers mentioned in the official guide.
...
#### 5. Send Test Request
Send a test request using [Ollama for local LLMs](https://kgateway.dev/docs/envoy/2.1.x/ai/ollama/):
