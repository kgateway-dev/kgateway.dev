...
{{< cards >}}
  ...
  {{< card link="https://agentgateway.dev/docs/kubernetes/latest/" title="Kgateway with agentgateway" subtitle="AI-first data plane for connectivity across agents, MCP tools, LLMs, and inferences. Written in Rust." image="img/logo-agentgateway-transparent.png" imageStyle="height: 200px; object-fit: contain; width: 100%; margin: 0 auto; display: block;">}}
{{< /cards >}}
</div>
...
{{< cards >}}
  ...
  {{< card link="https://agentgateway.dev/docs/kubernetes/latest/" title="Kgateway with agentgateway" subtitle="AI-first data plane for connectivity across agents, MCP tools, LLMs, and inferences. Written in Rust." image="img/logo-agentgateway-light-on-transparent.png" imageStyle="height: 200px; object-fit: contain; width: 100%; margin: 0 auto; display: block;">}}
{{< /cards >}}
</div>
