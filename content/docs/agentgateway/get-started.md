...
weight: 20
description: Get started quickly with agentgateway and kgateway.
---

Use {{< reuse "/docs/snippets/kgateway.md" >}} to manage [agentgateway](../about/) proxies for AI gateways in a Kubernetes environment. 
