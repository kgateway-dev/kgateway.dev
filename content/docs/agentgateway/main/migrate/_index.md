...
- **AgentGateway Emitter Support:** Generates Gateway API and AgentGateway-specific resources, e.g. AgentgatewayPolicy.
...
- Review the [AgentGateway emitter](./emitters/agentgateway/) to understand how providers such as ingress-nginx are mapped to AgentGateway-specific resources.
