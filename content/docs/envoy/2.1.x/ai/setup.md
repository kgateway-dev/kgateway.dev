...
1. [Upgrade]({{< link-hextra path="/envoy/latest/operations/upgrade/" >}}) {{< reuse "/docs/snippets/kgateway.md" >}} with the AI Gateway extension enabled. **Note**: To use AI Gateway with [agentgateway](/ai), see the [agentgateway docs]({{< link-hextra path="/agentgateway" >}}).
