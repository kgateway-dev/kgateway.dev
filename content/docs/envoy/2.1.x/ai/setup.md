...
1. [Upgrade]({{< link-hextra path="/operations/upgrade/" >}}) {{< reuse "/docs/snippets/kgateway.md" >}} with the AI Gateway extension enabled. **Note**: To use AI Gateway with agentgateway, see the [agentgateway docs](https://agentgateway.dev/docs/kubernetes/latest/).
