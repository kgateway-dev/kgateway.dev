...
1. [Upgrade]({{< link-hextra path="/operations/upgrade/" >}}) {{< reuse "/docs/snippets/kgateway.md" >}} with the AI Gateway extension enabled. **Note**: For AI Gateway with Agentgateway, see the [Agentgateway documentation](https://agentgateway.dev/docs).
