...
Keep in mind the following behaviors when using function calling with other AI Gateway features. For more details about these features, see the [API docs]({{< link-hextra path="/reference/api/#aipolicy" >}}).
