...
4. Check the gateway's access logs to verify that the request was not retried.
   ...
   ```sh
   kubectl logs -n {{< reuse "kgw-docs/snippets/namespace.md" >}} -l gateway.networking.k8s.io/gateway-name=http | tail -1
   ```
