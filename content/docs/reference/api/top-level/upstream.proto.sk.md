...
- [Backend](#upstream) **Top-Level Resource**
...
Backends represent destination for routing HTTP requests. Backends can be compared to
...
```yaml
"perBackendPreconnectRatio": .google.protobuf.DoubleValue
