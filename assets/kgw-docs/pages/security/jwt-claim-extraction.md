...
For instructions on extracting nested claims using dot notation, see the [nested claims section]({{< versioned_link_path fromRoot="/security/jwt/simple/claim-based-rbac/#nested-claims" >}}).