In this installation guide, you install {{< reuse "/kgw-docs/snippets/kgateway.md" >}} in a Kubernetes cluster by using [Argo CD](https://argoproj.github.io/cd/). Argo CD is a declarative continuous delivery tool that is especially popular for large, production-level installations at scale. This approach incorporates Helm configuration files.
...
Install {{< reuse "/kgw-docs/snippets/kgateway.md" >}} by using Argo CD.

{{< reuse "kgw-docs/snippets/argocd.md" >}}


## Next steps

Now that you have {{< reuse "/kgw-docs/snippets/kgateway.md" >}} set up and running, check out the following guides to expand your gateway capabilities.
