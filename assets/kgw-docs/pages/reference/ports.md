...
The {{< reuse "kgw-docs/snippets/kgateway.md" >}} installation process uses a Helm chart to create the necessary custom resource definitions (CRDs), deployments, services, pods, etc. The services and pods listen on specific ports to enable communication between the components that make up {{< reuse "kgw-docs/snippets/kgateway.md" >}}.

## Components

A standard installation of {{< reuse "kgw-docs/snippets/kgateway.md" >}} includes the following components:

* **{{< reuse "kgw-docs/snippets/kgateway-capital.md" >}} control plane**
...
* **{{< reuse "kgw-docs/snippets/kgateway-capital.md" >}} data plane (gateway proxy)**
...
| Pod | Port | Usage |
|-----|------|-------|
| {{< reuse "kgw-docs/snippets/pod-name.md" >}} | 9976 | REST xDS | 
| {{< reuse "kgw-docs/snippets/pod-name.md" >}} | 9977 | xDS Server |
