...
|----------|--------------|------------|----------------|-------|------|----------|
| 2.4.x | 23 July 2026 | 1.32 - 1.36 | 1.4 - 1.6 | Proxy 1.38, API v3 | >= 3.12 | 1.26 - 1.30 |
| 2.3.x | 19 May 2026 | 1.31 - 1.35 | 1.3 - 1.5 | Proxy 1.37, API v3 | >= 3.12 | 1.23 - 1.27 |
...
* Specify images for individual components by using variant tags in the `gloo.<component>.deployment.image.tag` field of the component's Helm settings, such as `quay.io/solo-io/gloo:v{{< reuse "kgw-docs/versions/n-patch.md" >}}-distroless`. -->

## Release cadence {#cadence}

Stable builds for kgateway are released as minor versions approximately every three months. A stable branch for a minor version, such as {{< reuse "kgw-docs/versions/short.md" >}}, is tagged from `main`, and stable builds are supported from that branch.
...
2. Release candidates are created, such as `{{< reuse "kgw-docs/versions/short.md" >}}.0-rc1`, `{{< reuse "kgw-docs/versions/short.md" >}}.0-rc2`, and so on.
