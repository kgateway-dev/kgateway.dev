Review the feature maturity of the {{< reuse "kgw-docs/snippets/kgateway.md" >}} project.

To receive feedback and improve functionality for real use cases, {{< reuse "kgw-docs/snippets/kgateway.md" >}} features are often released according to a feature maturity model. As the features are improved and stabilized, they are gradually moved through the stages of alpha, beta, and general availability (GA) support. 
...
Review the following table for the maturity of features in the {{< reuse "kgw-docs/snippets/kgateway.md" >}} project.
...
{{< reuse "kgw-docs/snippets/k8sgwapi-exp.md" >}}
