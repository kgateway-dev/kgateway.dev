...
> [!NOTE]
> Want to learn more about policy inheritance and overrides for {{< reuse "/kgw-docs/snippets/kgateway.md" >}} policies? See [{{< reuse "/kgw-docs/snippets/kgateway.md" >}} policies](../kgateway-policies/).
...
{{< reuse "kgw-docs/snippets/prereq-delegation.md" >}}
...
kubectl delete httproute parent -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
kubectl delete httproute child-team1 -n team1
kubectl delete httproute child-team2 -n team2
kubectl delete -n team1 -f https://raw.githubusercontent.com/kgateway-dev/kgateway.dev/main/assets/kgw-docs/examples/httpbin.yaml
kubectl delete -n team2 -f https://raw.githubusercontent.com/kgateway-dev/kgateway.dev/main/assets/kgw-docs/examples/httpbin.yaml
