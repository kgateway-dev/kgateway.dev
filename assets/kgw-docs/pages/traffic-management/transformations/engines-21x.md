In 2.1.x, {{< reuse "kgw-docs/snippets/kgateway.md" >}} uses the **classic transformation** engine. Classic transformation is a C++ filter that is statically linked into a custom Envoy build, and templates are powered by version 3.4 of the [Inja template engine](https://github.com/pantor/inja/tree/v3.4.0).
