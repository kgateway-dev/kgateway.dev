...
2. Verify that the sample app is up and running. 
   ```sh
   kubectl get pods -n {{< reuse "kgw-docs/snippets/namespace.md" >}} | grep grpc
   ```
...
3. Verify that the GRPCRoute is applied successfully.
   ...
   ```bash
   kubectl get grpcroute example-route -n {{< reuse "kgw-docs/snippets/namespace.md" >}} -o yaml
   ```
...
1. Port-forward the gateway proxy pod on port 8080.
   ```sh
   kubectl port-forward svc/grpc -n {{< reuse "kgw-docs/snippets/namespace.md" >}} 8080:80
   ```
...
```bash
kubectl delete grpcroute example-route -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
kubectl delete deployment grpc-echo -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
kubectl delete service grpc-echo-svc -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
kubectl delete pod grpcurl-client -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
kubectl delete gateway grpc -n {{< reuse "kgw-docs/snippets/namespace.md" >}}
```
