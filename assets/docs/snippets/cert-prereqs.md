...
4. {{< reuse "docs/snippets/prereq-listenerset.md" >}}. Note that you must install the experimental channel of the Kubernetes Gateway API at version {{< reuse "docs/versions/k8s-gw-version.md" >}} or later if you want to use ListenerSets. 