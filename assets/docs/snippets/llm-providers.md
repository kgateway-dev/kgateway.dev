...
* [OpenAI](https://platform.openai.com/docs/overview). You can also use `openai` support for LLM providers that use the OpenAI API, such as [DeepSeek]() and [Mistral](https://docs.mistral.ai/getting-started/quickstart/).
