...
* [API reference]({{< link-hextra path="/reference/api/" >}}){{< version include-if="2.1.x" >}}
* [Helm reference]({{< link-hextra path="/reference/helm/" >}}){{< version include-if="2.1.x" >}}
* [Control plane metrics]({{< link-hextra path="/observability/control-plane-metrics/">}}){{< /version >}}
