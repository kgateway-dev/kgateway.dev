...
2. Create a policy to define your path rewrite rules by using regular expressions. The following {{< reuse "docs/snippets/trafficpolicy.md" >}} finds a path that matches the `^/anything/stores/(.*)/entities` pattern, such as: 
