...
1. Create a ListenerPolicy with the `maxHeadersCount` setting.
   ...
   {{< reuse "docs/snippets/review-table.md" >}} For more information about the available fields, see the [API reference]({{< link-hextra path="/reference/api/#httpsettings" >}}).
...
```sh
kubectl delete listenerpolicy max-headers-count -n {{< reuse "docs/snippets/namespace.md" >}}
```
