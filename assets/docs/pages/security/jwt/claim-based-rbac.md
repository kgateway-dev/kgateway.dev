...
### Extract nested claims to headers {#nested-claims}

If your JWT contains nested claims, you can extract them using dot notation in the `claimsToHeaders` field.
...
```
**GatewayExtension configuration**:
